...
#define CANVIEW_UART_PROTOCOL_SCHEMA_SHA256 "477d162ed8557c863998f4fec9063b4315b494062995bdfc26003fa68e4dc18c"
...
static const canview_uart_message_policy_t CANVIEW_UART_MESSAGE_POLICIES[] = {
    {CANVIEW_UART_MSG_LINK_HELLO, 72U, 72U, UINT8_C(0), UINT8_C(0), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_LINK_HELLO_ACK, 40U, 40U, UINT8_C(2), UINT8_C(2), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_HEARTBEAT, 48U, 48U, UINT8_C(0), UINT8_C(16), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_ACK, 20U, 20U, UINT8_C(2), UINT8_C(2), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_ERROR, 20U, 20U, UINT8_C(4), UINT8_C(6), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_RX_BATCH, 12U, 204U, UINT8_C(0), UINT8_C(16), CANVIEW_UART_PAYLOAD_CAN_BATCH, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_BUS_STATUS, 28U, 28U, UINT8_C(16), UINT8_C(16), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_SAFETY_SNAPSHOT, 48U, 48U, UINT8_C(16), UINT8_C(16), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_TX_AUDIT, 40U, 40U, UINT8_C(2), UINT8_C(18), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_ID_STATS, 8U, 208U, UINT8_C(16), UINT8_C(16), CANVIEW_UART_PAYLOAD_BOUNDED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_OBSERVER_PLAN, 20U, 216U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_VARIANTS, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_CAPTURE_CONTROL, 28U, 28U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_CAPTURE_STATUS, 44U, 44U, UINT8_C(2), UINT8_C(18), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CAN_EVENT_MARKER, 28U, 28U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_COMMAND_REQUEST, 104U, 240U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_SUFFIX, UINT8_C(1)},
    {CANVIEW_UART_MSG_COMMAND_RESULT, 82U, 82U, UINT8_C(2), UINT8_C(18), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CONTROL_LEASE, 52U, 52U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CONFIG_GET, 24U, 24U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CONFIG_SET, 4U, 204U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_BOUNDED, UINT8_C(1)},
    {CANVIEW_UART_MSG_CONFIG_RESULT, 28U, 28U, UINT8_C(2), UINT8_C(18), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(1)},
    {CANVIEW_UART_MSG_DIAGNOSTIC_COUNTERS, 16U, 208U, UINT8_C(0), UINT8_C(16), CANVIEW_UART_PAYLOAD_BOUNDED, UINT8_C(1)},
    {CANVIEW_UART_MSG_FIRMWARE_PREPARE, 36U, 36U, UINT8_C(1), UINT8_C(9), CANVIEW_UART_PAYLOAD_FIXED, UINT8_C(0)},
};
