...
#define CANVIEW_PROTOCOL_SCHEMA_SHA256 "02ce0eea119158151a038c1b1b89600cc38a7e125df96193f09ff05518ed4108"
...
#define CANVIEW_ROLE_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_ROLE_KNOWN_MASK UINT32_C(0x0000000F)
...
#define CANVIEW_LINK_KNOWN_VALUE_COUNT UINT16_C(14)
#define CANVIEW_LINK_KNOWN_MASK UINT32_C(0x00003FFF)
...
#define CANVIEW_FLAG_KNOWN_VALUE_COUNT UINT16_C(7)
#define CANVIEW_FLAG_KNOWN_MASK UINT32_C(0x0000007F)

typedef enum {
    CANVIEW_MSG_CLASS_LINK = UINT32_C(1),
    CANVIEW_MSG_CLASS_TELEMETRY = UINT32_C(2),
    CANVIEW_MSG_CLASS_CONTROL = UINT32_C(4),
    CANVIEW_MSG_CLASS_DIAGNOSTIC = UINT32_C(8),
} canview_message_class_t;

#define CANVIEW_MSG_CLASS_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_MSG_CLASS_KNOWN_MASK UINT32_C(0x0000000F)
...
#define CANVIEW_PRIORITY_KNOWN_VALUE_COUNT UINT16_C(5)
#define CANVIEW_PRIORITY_KNOWN_MASK UINT32_C(0x0000001F)
...
#define CANVIEW_ACK_KNOWN_VALUE_COUNT UINT16_C(7)
#define CANVIEW_ACK_KNOWN_MASK UINT32_C(0x0000007F)
...
#define CANVIEW_COMMAND_KNOWN_VALUE_COUNT UINT16_C(7)
#define CANVIEW_COMMAND_KNOWN_MASK UINT32_C(0x0000007F)
...
#define CANVIEW_QUALITY_KNOWN_VALUE_COUNT UINT16_C(6)
#define CANVIEW_QUALITY_KNOWN_MASK UINT32_C(0x0000003F)
...
#define CANVIEW_EVIDENCE_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_EVIDENCE_KNOWN_MASK UINT32_C(0x0000000F)
...
#define CANVIEW_VALUE_KNOWN_VALUE_COUNT UINT16_C(6)
#define CANVIEW_VALUE_KNOWN_MASK UINT32_C(0x0000003F)
...
#define CANVIEW_BUS_FLAG_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_BUS_FLAG_KNOWN_MASK UINT32_C(0x0000000F)
...
#define CANVIEW_PRECOND_KNOWN_VALUE_COUNT UINT16_C(8)
#define CANVIEW_PRECOND_KNOWN_MASK UINT32_C(0x000000FF)

typedef enum {
    CANVIEW_SCOPE_AUDIO_PROFILE = UINT32_C(1),
    CANVIEW_SCOPE_AUDIO_VOLUME_OFFSET = UINT32_C(2),
    CANVIEW_SCOPE_AUDIO_FADER = UINT32_C(4),
    CANVIEW_SCOPE_AUDIO_BALANCE = UINT32_C(8),
    CANVIEW_SCOPE_AUDIO_MUTE = UINT32_C(0x10),
    CANVIEW_SCOPE_AUDIO_REAR_MUTE = UINT32_C(0x20),
    CANVIEW_SCOPE_AUDIO_SDVC = UINT32_C(0x40),
    CANVIEW_SCOPE_AUDIO_RESTORE = UINT32_C(0x80),
    CANVIEW_SCOPE_DRIVE_MODE_PULSE = UINT32_C(0x100),
    CANVIEW_SCOPE_ADAPTIVE_VOLUME_AUTOMATION = UINT32_C(0x200),
    CANVIEW_SCOPE_AUTO_SPORT_AUTOMATION = UINT32_C(0x400),
} canview_control_scope_t;

#define CANVIEW_CONTROL_SCOPE_AUDIO_PROFILE CANVIEW_SCOPE_AUDIO_PROFILE
#define CANVIEW_CONTROL_SCOPE_AUDIO_VOLUME_OFFSET CANVIEW_SCOPE_AUDIO_VOLUME_OFFSET
#define CANVIEW_CONTROL_SCOPE_AUDIO_FADER CANVIEW_SCOPE_AUDIO_FADER
#define CANVIEW_CONTROL_SCOPE_AUDIO_BALANCE CANVIEW_SCOPE_AUDIO_BALANCE
#define CANVIEW_CONTROL_SCOPE_AUDIO_MUTE CANVIEW_SCOPE_AUDIO_MUTE
#define CANVIEW_CONTROL_SCOPE_AUDIO_REAR_MUTE CANVIEW_SCOPE_AUDIO_REAR_MUTE
#define CANVIEW_CONTROL_SCOPE_AUDIO_SDVC CANVIEW_SCOPE_AUDIO_SDVC
#define CANVIEW_CONTROL_SCOPE_AUDIO_RESTORE CANVIEW_SCOPE_AUDIO_RESTORE
#define CANVIEW_CONTROL_SCOPE_DRIVE_MODE_PULSE CANVIEW_SCOPE_DRIVE_MODE_PULSE
#define CANVIEW_CONTROL_SCOPE_ADAPTIVE_VOLUME_AUTOMATION CANVIEW_SCOPE_ADAPTIVE_VOLUME_AUTOMATION
#define CANVIEW_CONTROL_SCOPE_AUTO_SPORT_AUTOMATION CANVIEW_SCOPE_AUTO_SPORT_AUTOMATION

#define CANVIEW_SCOPE_KNOWN_VALUE_COUNT UINT16_C(11)
#define CANVIEW_SCOPE_KNOWN_MASK UINT32_C(0x000007FF)
...
#define CANVIEW_COMMAND_ID_KNOWN_VALUE_COUNT UINT16_C(6)
...
#define CANVIEW_AUTOMATION_KNOWN_VALUE_COUNT UINT16_C(2)
#define CANVIEW_AUTOMATION_KNOWN_MASK UINT32_C(0x00000006)
...
#define CANVIEW_CONFIG_KNOWN_VALUE_COUNT UINT16_C(10)
...
#define CANVIEW_CAN_FILTER_FILTER_ACTION_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_CAN_FILTER_FILTER_ACTION_KNOWN_MASK UINT32_C(0x0000001E)
...
#define CANVIEW_CAN_FILTER_FILTER_RESULT_KNOWN_VALUE_COUNT UINT16_C(5)
#define CANVIEW_CAN_FILTER_FILTER_RESULT_KNOWN_MASK UINT32_C(0x0000001F)
...
#define CANVIEW_ERROR_KNOWN_VALUE_COUNT UINT16_C(20)
...
#define CANVIEW_OBSERVER_KNOWN_VALUE_COUNT UINT16_C(5)
#define CANVIEW_OBSERVER_KNOWN_MASK UINT32_C(0x0000001F)
...
#define CANVIEW_CAPTURE_CAPTURE_ACTION_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_CAPTURE_CAPTURE_ACTION_KNOWN_MASK UINT32_C(0x0000001E)
...
#define CANVIEW_CAPTURE_CAPTURE_STATE_KNOWN_VALUE_COUNT UINT16_C(7)
#define CANVIEW_CAPTURE_CAPTURE_STATE_KNOWN_MASK UINT32_C(0x0000007F)
...
#define CANVIEW_MARKER_KNOWN_VALUE_COUNT UINT16_C(5)
#define CANVIEW_MARKER_KNOWN_MASK UINT32_C(0x0000003E)
...
#define CANVIEW_DIAGNOSTIC_LEASE_DIAGNOSTIC_LEASE_ACTION_KNOWN_VALUE_COUNT UINT16_C(3)
#define CANVIEW_DIAGNOSTIC_LEASE_DIAGNOSTIC_LEASE_ACTION_KNOWN_MASK UINT32_C(0x0000000E)
...
#define CANVIEW_DIAGNOSTIC_LEASE_DIAGNOSTIC_LEASE_STATUS_KNOWN_VALUE_COUNT UINT16_C(4)
#define CANVIEW_DIAGNOSTIC_LEASE_DIAGNOSTIC_LEASE_STATUS_KNOWN_MASK UINT32_C(0x0000000F)
...
#define CANVIEW_REMOTE_CONFIG_KNOWN_VALUE_COUNT UINT16_C(6)
#define CANVIEW_REMOTE_CONFIG_KNOWN_MASK UINT32_C(0x0000003F)
...
#define CANVIEW_BULK_KNOWN_VALUE_COUNT UINT16_C(5)
#define CANVIEW_BULK_KNOWN_MASK UINT32_C(0x0000001F)
