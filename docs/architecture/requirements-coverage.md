...
| R-28 휴대폰 Diagnostic Bridge·인증·운행 정책 | [Bridge §5·14](diagnostic-bridge.md), [통합 §14](implementation-readiness.md) | T-400, T-402 | T-400 C web bootstrap·인증 source와 ESP-IDF target compile; observer/capture/backend 및 physical evidence 미완료 | 고정 KR channel·memory bearer·1 client·physical service·PII redaction·이동/active lease bulk pause |
