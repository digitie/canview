...
| 날짜 | 종류 | 기준선·범위 | 리뷰어 | 결과 |
|---|---|---|---|---|
| 2026-09-07 | T-400a Bridge core post-fix closure | `5821fca`→`5d6fac4`, 공용 ESP core/app·BSP·sdkconfig·generator·host/target | embedded runtime / SDK·build·evidence | [report](adversarial/2026-09-07-T-400a.md), A-05는 P0–P3 없음 `CONDITIONAL`; B-05/B-06은 candidate-artifact provenance P1 `BLOCK`. clean CI target manifest 18/18은 확인했으나 evidence candidate B 재검토, Windows C99 CI failure, physical gate가 미완료 |
