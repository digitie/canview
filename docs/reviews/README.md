...
| 날짜 | 종류 | 기준선·범위 | 리뷰어 | 결과 |
|---|---|---|---|---|
| 2026-09-07 | T-400 P2 Bridge handoff | `c8a725d` → `8f32c07`, board identity/profile·ISR/pool·safe GPIO | embedded runtime / SDK·generator·CMake | [report](adversarial/2026-09-07-T-400.md), initial A/B `BLOCK` P1/P2; first post-fix A/B whole-diff execution은 독립성 무효 `BLOCK`, fresh source-only A/B는 P0/P1 없음·B coverage P2. P2 수정 C3의 re-review·CI와 physical/HIL은 `NOT_RUN` |
