...
| 날짜 | 종류 | 기준선·범위 | 리뷰어 | 결과 |
|---|---|---|---|---|
| 2026-09-07 | T-400a Bridge core post-fix closure | `5821fca`→`5d6fac4`→`a5ae85b`, 공용 ESP core/app·BSP·sdkconfig·generator·host/target | embedded runtime / SDK·build·evidence | [report](adversarial/2026-09-07-T-400a.md), A-05/B-07 `CONDITIONAL`, unresolved P0/P1 없음; B artifact provenance P1은 `FIXED`. final branch CI와 physical gate는 별도 미완료 |
