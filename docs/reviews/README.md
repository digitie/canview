...
| 날짜 | 종류 | 기준선·범위 | 리뷰어 | 결과 |
|---|---|---|---|---|
| 2026-09-07 | T-004 UART schema/codec 최종 post-fix | `3c6967a` 구현·`d5d323f` evidence, semantic ABI·COBS/CRC·session/replay·queue ownership·실제 69.12GB duplex soak | embedded 안전/runtime / protocol·security·build | [report·독립 원문·검증](adversarial/2026-09-07-T-004.md), 코드 P0/P1 없음·A 문구 조건 반영·B 범위 PASS·원격 CI 대기 |
