...
남은 설계 작업: MAX20040 land90-0409 원본과 KiCad footprint overlay, 미확보 원문/구판 변경 검토, 구매 R/C 확정, thermal/loop/SOA 계산서, 실제 harness 검증. PCB와 실물 fault evidence는 T-101에서 수행한다. 현재 generated file만 보고 제작 발주하지 않는다.
...
- [x] TXD/RXD/STB/EN, rails, reset, UART, gate에 test point가 있다. 24개1mm pad.
