...
| ID | 상태 | 우선순위 | 작업 | 선행 |
|---|---|---:|---|---|
| [T-001](tasks/T-001-host-toolchain-ci.md) | IN_PROGRESS | P0 | 재현 가능한 host toolchain과 CI | 없음 |
| [T-002](tasks/T-002-espnow-schema-v1.3.md) | BLOCKED | P0 | ESP-NOW v1.3 schema와 생성 header 동결 | T-001 |
