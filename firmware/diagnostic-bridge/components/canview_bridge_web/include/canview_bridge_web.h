...
#define CANVIEW_BRIDGE_WEB_PRE_AUTH_TIMEOUT_MS (15000U)
#define CANVIEW_BRIDGE_WEB_REQUEST_TIMEOUT_MS (15000U)
#define CANVIEW_BRIDGE_WEB_WORKER_HEARTBEAT_TIMEOUT_MS (1500U)
