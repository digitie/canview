...
#define CANVIEW_STM_FDCAN_PLATFORM_ERROR_FIFO_LOSS CANVIEW_STM_FDCAN_ERROR_FIFO_LOSS
#define CANVIEW_STM_FDCAN_PLATFORM_ERROR_RAW_RING_OVERFLOW CANVIEW_STM_FDCAN_ERROR_RAW_RING_OVERFLOW
#define CANVIEW_STM_FDCAN_PLATFORM_ERROR_MESSAGE_RAM CANVIEW_STM_FDCAN_ERROR_MESSAGE_RAM
...
typedef struct
{
    ...
    uint32_t session_fault_flags[CANVIEW_STM_FDCAN_CHANNEL_COUNT];
